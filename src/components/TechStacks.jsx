        ...
        {/* Flutter */}
          ...
          icon={
            <svg
              ...
              viewBox="0 0 256 256"
            >
              <path fill="#47C5FB" d="M156.176 22.635L41.412 137.4l32.56 32.56 116.736-116.8-34.528-30.528zM189.688 105.848l-31.408 31.472 31.408 31.472 32.56-31.472-32.56-31.472zM98.512 172.76l91.184 91.12 34.528-34.496-90.064-90.128-35.648 33.504z"></path>
            </svg>
          }
        />
          ...
          <TheStackIcon
            ...
            icon={
              <svg
                ...
                viewBox="0 0 256 256"
              >
                <path fill="#306998" d="M128 0c35.3 0 64 28.7 64 64s-28.7 64-64 64-64-28.7-64-64 28.7-64 64-64z"></path>
                <path fill="#FFD43B" d="M128 192c-35.3 0-64-28.7-64-64s28.7-64 64-64 64 28.7 64 64-28.7 64-64 64z"></path>
                <path fill="#FFD43B" d="M112 128c0 4.4 3.6 8 8 8h16c4.4 0 8-3.6 8-8v-32c0-4.4-3.6-8-8-8h-16c-4.4 0-8 3.6-8 8v32z"></path>
                <path fill="#306998" d="M128 64c-17.7 0-32 14.3-32 32v32h64V96c0-17.7-14.3-32-32-32z"></path>
              </svg>
            }
          />
            ...
            <TheStackIcon
              ...
              icon={
                ...
                >
                  <path
                    fill="currentColor"
                    d="M12 0C5.37 0 0 5.37 0 12c0 5.25 3.29 9.74 7.87 11.34.58.11.79-.25.79-.55 0-.28-.01-1.02-.01-2.01-2.99.65-3.62-1.43-3.62-1.43-.49-1.24-1.21-1.57-1.21-1.57-.99-.68.08-.66.08-.66 1.09.08 1.66 1.13 1.66 1.13.97 1.65 2.55 1.17 3.17.89.1-.7.38-1.17.69-1.44-2.33-.26-4.77-1.17-4.77-5.21 0-1.15.41-2.09 1.08-2.83-.11-.26-.47-1.28.1-2.66 0 0 .89-.29 2.9 1.08 1.03-.29 2.13-.44 3.22-.44 1.1 0 2.2.14 3.22.44 2.01-1.37 2.9-1.08 2.9-1.08.57 1.38.21 2.4.1 2.66.67.74 1.08 1.68 1.08 2.83 0 4.05-2.44 4.94-4.77 5.21.39.38.74 1.13.74 2.27 0 1.64-.01 2.96-.01 3.36 0 .3.21.66.8.55C20.71 21.74 24 17.25 24 12c0-6.63-5.37-12-12-12z"
                  />
                </svg>
              }
            />
